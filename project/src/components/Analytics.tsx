      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            ...
            <p className="text-purple-100 text-sm">Real-time measurements</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center p-4">
            ...
            <p className="text-sm text-gray-600">Real-time data from 25+ monitoring stations across major Indian cities</p>
          </div>
          <div className="text-center p-4">
          ...
          <div className="text-center p-4">
            ...
            <p className="text-sm text-gray-600">7-day forecasts with 89% accuracy for better planning</p>
          </div>
        </div>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our AI model shows 89% accuracy for 24-hour predictions and 82% accuracy for 7-day forecasts based on 5.2M data points.
              </p>
            </div>
          </div>
